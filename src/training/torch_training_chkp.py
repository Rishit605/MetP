...
n_epochs = 50 
input_size = X.shape[-1] # Number of features (excluding target column)
hidden_size = 32
num_layers = 2
...
def history_plotting(train, test):
    plt.plot(train, scalex=True, label='Training Loss')
...
if __name__ == "__main__":
    ...
    # try:
    #     loaded_model = load_model(r'C:\Projs\COde\Meteo\MetP\src\model\new_best_lstm_model.pth')
